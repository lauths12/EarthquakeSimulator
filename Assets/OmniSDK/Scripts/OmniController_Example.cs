...
    void Update()

    {
...

        {
            ...
            {        // This line replaces the existing if statements, although the one in “OmniMovementComponent.cs” “== false” and the one in "OmniController_Example.cs" should be “== true”
